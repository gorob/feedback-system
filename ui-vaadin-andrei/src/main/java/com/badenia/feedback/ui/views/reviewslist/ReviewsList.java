 ...
 * the License.
 */
package com.badenia.feedback.ui.views.reviewslist;
...
import com.badenia.feedback.backend.Review;
import com.badenia.feedback.backend.ReviewService;
import com.badenia.feedback.ui.MainLayout;
import com.badenia.feedback.ui.common.AbstractEditorDialog;
import com.badenia.feedback.ui.encoders.LocalDateToStringEncoder;
import com.badenia.feedback.ui.encoders.LongToStringEncoder;
...
public class ReviewsList extends PolymerTemplate<ReviewsModel> {
    ...
    public ReviewsList() {
//        search.setPlaceholder("Search reviewsss");

...
public class FeedbackClientServiceIntegrationTest {
	...
	public void testLeseAlleEvents() throws Exception {
	    ...
	    assertEquals((Long)3L, event.getQuestions().get(1).getId());
	    ...
	    assertEquals((Long)4L, event.getQuestions().get(2).getId());
	    ...
	    assertEquals((Long)5L, event.getQuestions().get(3).getId());
